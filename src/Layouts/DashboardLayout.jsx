            ...
            <div className="drawer-side is-drawer-close:overflow-visible">
                ...
                <div className="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-14 is-drawer-open:w-64">
                    ...
                    <ul className="menu w-full grow">
                        {/* List item */}
                        <li>
                            <Link to={'/'} className='text-xl font-bold bg-gradient-to-r from-purple-500 to-pink-500 bg-clip-text text-transparent'>C</Link>
                        </li>
                        <li>
                        ...
                        }
                        {
                            role === 'clubManager' && <>
                                ...
                                <li>
                                    <NavLink className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Events Management" to="/dashboard/event-management">
                                        <MdEvent />
                                        <span className="is-drawer-close:hidden">Events Management</span>
                                    </NavLink>
                                </li>
                                <li>
                                    <NavLink className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Event Registrations" to="/dashboard/event-registrations">
                                        <GiArchiveRegister />
                        ...
                        {/* admin only links */}
                        {
                            role === 'admin' && <>
                                <li>
                                    <NavLink className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Manage Users" to="/dashboard/users-management">
                                        <FaUsers />
